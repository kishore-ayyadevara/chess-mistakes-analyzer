export const chessPieces = {
    ...
    'k': `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 45 45">
        <g fill="none" fill-rule="evenodd" stroke="#000" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5">
            ...
            <path d="M20 8h5" stroke-linejoin="miter" fill="#000"/>
            ...
            <path d="M20 32h5" stroke="#ececec" stroke-width="0.75"/>
            <path d="M11.5 30c5.5-3 15.5-3 21 0" stroke="#ececec" stroke-width="0.75"/>
            <path d="M12 33.5c5-2.5 15-2.5 20 0" stroke="#ececec" stroke-width="0.75"/>
            <path d="M12 36.5c5-2.5 15-2.5 20 0" stroke="#ececec" stroke-width="0.75"/>
        </g>
    </svg>`,
    'q': `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 45 45">
    ...
    'r': `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 45 45">
        <g fill-rule="evenodd" stroke="#000" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5">
            <path d="M9 39h27v-3H9v3zm3.5-7l1.5-2.5h17l1.5 2.5h-20zm-.5 4v-4h21v4H12z" fill="#000" stroke-linecap="butt"/>
